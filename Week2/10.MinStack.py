...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 10 12:01:30 2020
...
"""
Problem URL: https://leetcode.com/explore/challenge/card/30-day-leetcoding-challenge/529/week-2/3292/
...
class MinStack:
    ...
    def pop(self) -> None:
        ...
        if val <= self.min:
            ...
            # stack is empty - set min to None
            else:
                self.min = None
        return retVal
